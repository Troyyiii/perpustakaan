                    ...
                    <form id="formAuthentication" class="mb-3" action="/registerStore" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name')
                                is-invalid @enderror" id="name" name="name" placeholder="Nama lengkap" autofocus
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kelas')
                                        is-invalid @enderror" id="kelas" name="kelas" placeholder="Kelas" autofocus
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="tel" pattern="[0-9]{4}" class="form-control @error('tahun_angkatan')
                                        is-invalid @enderror" id="tahun_angkatan" name="tahun_angkatan"
                                        placeholder="Tahun angkatan" value="{{ old('tahun_angkatan') }}" required />
