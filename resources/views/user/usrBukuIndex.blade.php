        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Perpustakaan /</span> Daftar Buku
                    </h4>
                    <div class="row">
                        <div class="mb-4 order-0">
                            {{-- data buku --}}
                            <div class="card">
                                <h2 class="card-header text-center fw-bold">Daftar Buku</h2>
                                ...
                                <div class="table-responsive text-nowrap">
                                    <table class="table table-hover">
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            ...
                                            @endforeach
                                            @if ($i == '0')
                                            <td class="text-center" colspan="7">Tidak ditemukan buku di perpustakaan
                                            </td>
                                            @endif
                                        </tbody>
                                    </table>
