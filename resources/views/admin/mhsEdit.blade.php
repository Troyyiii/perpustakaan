...
@section('title')
E-Library | Edit Mahasiswa - Admin
@endsection
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Database / Data Mahasiswa /</span>
                        Edit Data</h4>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-9">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form class="form-check" action="{{ route('updateMhs', $mahasiswa->id) }}"
                                        method="POST">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="kelas" id="kelas" value="{{ $mahasiswa->kelas }}"
                                                        class="form-control" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="tahun_angkatan" id="tahun_angkatan"
                                                        value="{{ $mahasiswa->tahun_angkatan }}" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
