        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Database /</span> Data Mahasiswa
                    </h4>

                    <!-- Basic Bootstrap Table -->
                    <div class="card">
                        <h2 class="card-header text-center fw-bold">Data Mahasiswa</h2>
                        {{-- <form action="{{ route('mhsCreate') }}" class="m-2">
                            @csrf
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table">
                                ...
                                <tbody class="table-border-bottom-0">
                                            ...
                                            <div class="row">
                                                <div class="col-auto">
                                                    <form action="{{ route('showMhs', $dataMhs->id) }}">
                                                        @csrf
                                                        <button type="submit button" class="btn btn-info"><i
                                                ...
                                                <div class="col-auto">
                                                    <form action="{{ route('deleteMhs', $dataMhs->id) }}">
                                                        ...
                                                        <button type="submit button" class="btn btn-danger"
                                                            onclick="return confirm('Hapus data mahasiswa atas nama {{ $dataMhs->nama }}')"><i
                                    ...
                                    @endforeach
                                    @if ($i == '0')
                                    <td class="text-center" colspan="8">Tidak terdapat data mahasiswa</td>
                                    @endif
                                </tbody>
                            </table>
                        </div>
