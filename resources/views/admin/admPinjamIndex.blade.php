        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Database /</span> Data Peminjaman
                    </h4>
                    <form action="{{ route('admHstPinjam') }}" class="mb-4">
                        @csrf
                        <button type="submit button" class="btn btn-primary"><i
                            class="menu-icon tf-icons bx bx-history"></i>History Peminjaman</button>
                    </form>
                    <div class="card">
                        <h2 class="card-header text-center fw-bold">Data Peminjaman</h2>
                                ...
                                <tbody class="table-border-bottom-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-auto">
                                                    <form action="{{ route('admPinjamInfo', $dataPinjam->id) }}">
                                                        @csrf
                                                        <button type="submit button" class="btn btn-warning"><i
                                                                class="menu-icon tf-icons bx bxs-info-circle"></i>Lihat
                                                            detail</button>
                                                    </form>
                                                </div>
                                            </div>
                                    ...
                                    @endforeach
                                    @if ($i == '0')
                                    <td class="text-center" colspan="8">Tidak terdapat data peminjaman</td>
                                    @endif
                                </tbody>
                            </table>
                        </div>
