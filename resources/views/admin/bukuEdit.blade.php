        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Database / Data Buku /</span> Edit
                        Data</h4>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-9">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form class="form-check" action="{{ route('updateBuku', $buku->id) }}"
                                        method="POST">
                                        @csrf
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="penerbit" id="penerbit"
                                                        value="{{ $buku->penerbit }}" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="genre_buku" id="genre_buku"
                                                        value="{{ $buku->created_at->format('D M Y') }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="genre_buku" id="genre_buku"
                                                value="{{ $buku->genre_buku }}" class="form-control" required>
                                        </div>
