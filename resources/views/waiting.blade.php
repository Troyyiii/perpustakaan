...
<html
  ...
  data-assets-path="{{ asset('template/sneat/assets/') }}"
...
>
  <head>
    ...
    <title>E-Library | Waiting Verify</title>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset('template/sneat/assets/vendor/css/pages/page-misc.css') }}" />
    <!-- Helpers -->
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            <h2 class="mb-2 mx-2">Akun Belum Terverifikasi</h2>
            <p class="mb-4 mx-2">Mohon maaf akun anda masih belum terverifikasi, mohon tunggu sampai akun telah diverifikasi.</p>
            <a href="{{ route('logout') }}" class="btn btn-warning">Kembali Ke Halaman Login</a>
            <div class="mt-4">
                <img src="{{ asset('template/sneat/assets/img/illustrations/girl-doing-yoga-light.png') }}" alt="girl-doing-yoga-light" width="500"
